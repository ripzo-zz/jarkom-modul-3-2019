...
**STEP 5** - Ubah pengaturan proxy browser. Gunakan **IP mewtwo** sebagai host dan isikan port **7777
...
![Gambar](images/25.png) ![Gambar](images/26.png)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY3MzM3NTRdfQ==
-->
